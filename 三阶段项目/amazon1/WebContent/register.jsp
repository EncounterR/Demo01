...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="HwuaUserServlet?org=reg" onsubmit="return checkForm(this)">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input id="nickName" class="text" type="text" name="nickName" onfocus="FocusItem(this)" onblur="CheckItem(this);"  maxlength="15"/><span id="nName"></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input class="text verycode" id="veryCode" type="text" name="veryCode" onfocus="FocusItem(this)" onblur="CheckItem(this);" maxlength="4"/><img id="veryCode" src="code.jsp" /><span id="Code"></span></td>
					</tr>
					<tr>
						<td></td>
