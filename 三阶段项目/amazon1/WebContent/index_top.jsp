...
<div id="header">
			...
			<ul class="m_right">
				<c:choose>
					<c:when test="${user!=null }">
						<li><img src="images/icon_3.png"><a href="HwuaProductServlrt?org=shopping"
							class="c_red">购物车</a></li>
						<li><img src="images/icon_2.png"><a href="CommentServlet?org=list">我的评论</a></li>
						<li><img src="images/icon_2.png"><a href="OrderDetallServlet?org=list">所有订单</a></li>
					</c:when>
					<c:otherwise>
						<li><img src="images/icon_3.png"><a
							href="javascript:tips()" class="c_red">购物车</a></li>
							<li><img src="images/icon_2.png"><a href="javascript:tips()">我的评论</a></li>
							<li><img src="images/icon_2.png"><a href="javascript:tips()">所有订单</a></li>
					</c:otherwise>
				</c:choose>
	...
	<div class="logo_search">
		...
		<div class="search">
			<form action="HwuaProductServlrt?org=query" method="post">
			<input type="text" placeholder="输入宝贝" id="qname" name="qname"/>
			<input class="query_button" type="submit" value="搜索">
			</form>
		</div>
	</div>
	<div class="nav_bar">
